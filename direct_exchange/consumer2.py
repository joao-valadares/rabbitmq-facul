"""
Consumer 2 para Direct Exchange
Consome mensagens com routing key 'warning'
"""
import sys
import os
import json
...
def main():
    ...
    CONSUMER_ID = "WARNING_CONSUMER"
    EXCHANGE_NAME = "direct_exchange_demo"
    EXCHANGE_TYPE = "direct"
    QUEUE_NAME = "direct_queue_warning"
    ROUTING_KEY = "warning"
    ...
    def callback(ch, method, properties, body):
        ...
        try:
            ...
            # Simula processamento mais lento para warnings
            time.sleep(1.5)
